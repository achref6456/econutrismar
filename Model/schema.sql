...
CREATE TABLE IF NOT EXISTS commentaire (
  ...
  CONSTRAINT fk_com_blog FOREIGN KEY (id_article) REFERENCES blog (id_article) ON DELETE CASCADE,
  CONSTRAINT fk_com_user FOREIGN KEY (user_id) REFERENCES utilisateur (id_user) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
